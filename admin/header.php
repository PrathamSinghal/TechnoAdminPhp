...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/additional.css?v=1.2.0" type="text/css">
        ...
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header  align-items-center">
                <a class="navbar-brand" href="javascript:void(0)">
                    <img src="../assets/img/logo.png" class="navbar-brand-img" alt="Bhaarat Go">
                </a>
            </div>
                ...
                <span class="nav-link-text">Profile</span>
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="lessons.php">
                                <i class="ni 
ni-single-copy-04 text-pink"></i>
                                <span class="nav-link-text">Lessons Management</span>
                            </a>
                        </li>
                        <li class="nav-item">
...
ni-single-copy-04 text-pink"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="brand.php">
                                <i class="ni ni-pin-3 text-primary"></i>
                                <span class="nav-link-text">Vehicle Brand</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="model.php">
                                <i class="ni ni-email-83 text-primary"></i>
                                <span class="nav-link-text">Vehicle model</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="version.php">
                                <i class="ni ni-email-83 text-primary"></i>
                                <span class="nav-link-text">Vehicle versions</span>
                            </a>
                        </li>
                        <li class="nav-item">
              ...
              <i class="ni ni-key-25 text-info"></i>
                <span class="nav-link-text">Set charges</span>
              </a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Set search range</span>
              </a>
            </li> -->
                    </ul>
                    <!-- Divider -->
    ...
    <div class="main-content" id="panel">
        <!-- Topnav -->
        <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom bg-additional">
